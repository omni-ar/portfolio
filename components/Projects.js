        ...
        <div className="space-y-10 relative border-l-4 border-indigo-500">
          {projects.map((project, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="ml-6 relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:scale-105 transition-transform duration-300"
            >
              <span className="absolute left-[-14px] top-4 w-4 h-4 bg-indigo-600 rounded-full border-4 border-white dark:border-gray-800"></span>
